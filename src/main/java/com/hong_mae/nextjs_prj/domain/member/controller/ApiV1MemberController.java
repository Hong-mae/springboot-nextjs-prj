...
public class ApiV1MemberController {
    ...
    @PostMapping("/login")
    public ReturnData<LoginResponse> login(@Valid @RequestBody LoginRequest loginRequest, HttpServletResponse resp) {
        ...
        ResponseCookie cookie = ResponseCookie.from("accessToken", authData.getData().getAccessToken())
                .path("/")
                .sameSite("None")
                .secure(true)
                .httpOnly(true)
